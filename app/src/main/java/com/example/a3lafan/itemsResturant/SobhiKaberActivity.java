...
public class SobhiKaberActivity extends AppCompatActivity {
    ViewFlipper mFlipper;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sobhi_kaber);
        int img []={R.drawable.so2,R.drawable.so3,R.drawable.so4};
